...
rootClusterKmeans.title("Graphique t-SNE Cluster k-means")
...
figClusterKmeans.savefig("/Users/camilleauvity/Desktop/ECOLE/Projet-Industriel/resultats t-SNE/Plot-tSNE/Projection cluster k-means 3D.png", format='png', dpi=300)  # `dpi=300` pour une haute qualité
